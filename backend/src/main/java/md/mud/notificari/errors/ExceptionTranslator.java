...
public class ExceptionTranslator extends ResponseEntityExceptionHandler {
    ...
    private HttpHeaders buildHeaders(Throwable err) {
        ...
        if (err instanceof EntityErrorException entityErrorException) {
            return HeaderUtil.createFailureAlert(
                applicationName,
                true,
                entityErrorException.getEntityName(),
                entityErrorException.getErrorKey(),
                entityErrorException.getMessage()
            );
        }
        return null;
    }
    ...
    private boolean containsPackageName(String message) {
        ...
        return Strings.CS.containsAny(message, "org.", "java.", "net.", "jakarta.", "javax.", "com.", "io.", "de.", "md.mud.notificari");
    }
}
